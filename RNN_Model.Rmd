...
train <- Z_416_AR_List[[j]][c(1:floor(0.8 * nrow(Z_416_AR_List[[j]]))), ] 
test <- Z_416_AR_List[[j]][-c(1:floor(0.8 * nrow(Z_416_AR_List[[j]]))), ]
...
# V0 <- var(test[, "Y"])
# 
# 1 - mean((arpred - test[,"Y"])^2) / V0



sum(arpred)
length(test[,"Y"])
mean((arpred - test[,"Y"])^2) / V0

Z_416_AR_List[[2]][-c(1:floor(0.8 * nrow(Z_416_AR_List[[2]]))), "Y"] %>% class()

Z_416_AR_List[[2]][-c(1:floor(0.8 * nrow(Z_416_AR_List[[2]]))), "Y"] %>% class()
Z_416_AR_List[[2]][-c(1:2),] %>% class()
```
